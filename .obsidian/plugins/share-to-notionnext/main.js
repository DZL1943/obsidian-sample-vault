...
// node_modules/@tryfabric/martian/node_modules/micromark-extension-math/lib/tokenize-math-flow.js
var require_tokenize_math_flow = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/micromark-extension-math/lib/tokenize-math-flow.js"(exports) {
    "use strict";
...
// node_modules/@tryfabric/martian/node_modules/micromark-extension-math/lib/tokenize-math-text.js
var require_tokenize_math_text = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/micromark-extension-math/lib/tokenize-math-text.js"(exports) {
    "use strict";
...
// node_modules/@tryfabric/martian/node_modules/micromark-extension-math/lib/syntax.js
var require_syntax5 = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/micromark-extension-math/lib/syntax.js"(exports) {
    "use strict";
...
// node_modules/@tryfabric/martian/node_modules/micromark-extension-math/index.js
var require_micromark_extension_math = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/micromark-extension-math/index.js"(exports, module2) {
    module2.exports = require_syntax5();
  }
});

// node_modules/@tryfabric/martian/node_modules/mdast-util-math/from-markdown.js
var require_from_markdown6 = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/mdast-util-math/from-markdown.js"(exports) {
    "use strict";
    exports.enter = {
...
// node_modules/@tryfabric/martian/node_modules/mdast-util-math/to-markdown.js
var require_to_markdown6 = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/mdast-util-math/to-markdown.js"(exports) {
    "use strict";
    exports.unsafe = [
...
// node_modules/@tryfabric/martian/node_modules/remark-math/index.js
var require_remark_math = __commonJS({
  "node_modules/@tryfabric/martian/node_modules/remark-math/index.js"(exports, module2) {
    "use strict";
...
function updateYamlInfo(yamlContent, nowFile, res, app, plugin, dbDetails) {
  return __async(this, null, function* () {
    ...
    yield app.fileManager.processFrontMatter(nowFile, (yamlContent2) => {
      ...
      yamlContent2[linkKey] = url;
    });
    try {
      yield navigator.clipboard.writeText(url);
    } catch (error) {
      new import_obsidian4.Notice(`\u590D\u5236\u94FE\u63A5\u5931\u8D25\uFF0C\u8BF7\u624B\u52A8\u590D\u5236${error}`);
    }
  });
}

// node_modules/@tryfabric/martian/src/notion/common.ts
var LIMITS = {
  PAYLOAD_BLOCKS: 1e3,
  RICH_TEXT_ARRAYS: 100,
  RICH_TEXT: {
...
// node_modules/@tryfabric/martian/src/notion/blocks.ts
...
var Upload2NotionNext = class extends UploadBaseNext {
  ...
  createPage(title, emoji, cover, tags, type, slug, stats, category, summary, pawrod, favicon, datetime, childArr) {
    return __async(this, null, function* () {
      ...
      try {
        return yield (0, import_obsidian5.requestUrl)({
        ...
        new import_obsidian5.Notice(`network error ${error}`);
      }
    });
  }
  syncMarkdownToNotionNext(title, emoji, cover, tags, type, slug, stats, category, summary, paword, favicon, datetime, markdown, nowFile, app) {
    return __async(this, null, function* () {
      ...
      const frontmasster = (_a = app.metadataCache.getFileCache(nowFile)) == null ? void 0 : _a.frontmatter;
      ...
      if (res.status === 200) {
        yield updateYamlInfo(markdown, nowFile, res, app, this.plugin, this.dbDetails);
      } else {
        new import_obsidian5.Notice(`${res.text}`);
      }
      return res;
    });
  }
...
var Upload2NotionGeneral = class extends UploadBaseGeneral {
  ...
  createPage(title, cover, tags, childArr) {
    return __async(this, null, function* () {
      ...
      try {
        return yield (0, import_obsidian7.requestUrl)({
          url: `https://api.notion.com/v1/pages`,
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        new import_obsidian7.Notice(`network error ${error}`);
      }
    });
  }
  syncMarkdownToNotionGeneral(title, cover, tags, markdown, nowFile, app) {
    return __async(this, null, function* () {
      ...
      if (res.status === 200) {
        ...
        new import_obsidian7.Notice(`${res.text}`);
      }
      return res;
    });
  }
...
var Upload2NotionCustom = class extends UploadBaseCustom {
  ...
  createPage(cover, customValues, childArr) {
    return __async(this, null, function* () {
      ...
      const bodyString = this.buildBodyString(customProperties, customValues, childArr);
      if (cover) {
        bodyString.cover = {
          type: "external",
          external: {
      ...
      try {
        return yield (0, import_obsidian9.requestUrl)({
          url: `https://api.notion.com/v1/pages`,
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        new import_obsidian9.Notice(`network error ${error}`);
      }
    });
  }
  syncMarkdownToNotionCustom(cover, customValues, markdown, nowFile, app) {
    return __async(this, null, function* () {
      ...
      if (res.status === 200) {
        ...
        new import_obsidian9.Notice(`${res.text}`);
      }
      return res;
    });
  }
...
function uploadCommandNext(plugin, settings, dbDetails, app) {
  return __async(this, null, function* () {
    ...
    if (markDownData) {
      ...
      if (res.status === 200) {
        new import_obsidian13.Notice(`${i18nConfig["sync-success"]}${basename}`);
      } else {
...
// src/ui/CustomModal.ts
var import_obsidian14 = require("obsidian");
var CustomModal = class extends import_obsidian14.Modal {
  constructor(app) {
    super(app);
    this.propertyLines = [];
  ...
  createPropertyLine(containerEl) {
    const propertyIndex = this.properties.length;
    this.properties.push({ customName: "", customType: "" });
    const propertyLine = new import_obsidian14.Setting(containerEl);
    if (propertyIndex === 0) {
      propertyLine.setName(i18nConfig.CustomPropertyFirstColumn).setDesc(i18nConfig.CustomPropertyFirstColumnDesc);
      propertyLine.addText(
        (text) => {
          text.setPlaceholder("Property name").setValue("").onChange((value) => __async(this, null, function* () {
            this.properties[propertyIndex].customName = value;
          }));
        }
      );
      propertyLine.addDropdown(
        (dropdown) => {
          dropdown.addOption("title", "Title").setValue("").onChange((value) => __async(this, null, function* () {
            this.properties[propertyIndex].customType = value;
          }));
        }
      );
    } else {
      propertyLine.setName(i18nConfig.CustomProperty + propertyIndex);
      propertyLine.addText(
        (text) => {
          text.setPlaceholder(i18nConfig.CustomPropertyName).setValue("").onChange((value) => __async(this, null, function* () {
            this.properties[propertyIndex].customName = value;
          }));
        }
      );
      propertyLine.addDropdown(
        (dropdown) => {
          dropdown.addOption("text", "Text").addOption("number", "Number").addOption("select", "Select").addOption("multi_select", "Multi-Select").addOption("date", "Date").addOption("files", "Files & Media").addOption("checkbox", "Checkbox").addOption("url", "URL").addOption("email", "Email").addOption("phone_number", "Phone Number").setValue("").onChange((value) => __async(this, null, function* () {
            this.properties[propertyIndex].customType = value;
          }));
        }
      );
      propertyLine.addButton(
        (button) => {
  ...
  display() {
    ...
    new import_obsidian14.Setting(customDiv).setName(i18nConfig.AddNewProperty).setDesc(i18nConfig.AddNewPropertyDesc).addButton((button) => {
      return button.setTooltip("Add").setIcon("plus").onClick(() => __async(this, null, function* () {
    ...
    saveButton.addExtraButton(
      (button) => {
        return button.setTooltip("Cancel").setIcon("cross").onClick(() => __async(this, null, function* () {
          this.close();
        }));
      }
    );
...
// src/ui/settingModal.ts
var SettingModal = class extends import_obsidian15.Modal {
  ...
  display() {
    ...
    if (this.data.saved) {
      new import_obsidian15.Setting(settingDiv).setName(i18nConfig.databaseFormat).setDesc(i18nConfig.databaseFormatDesc).addDropdown((component) => {
    ...
    let saveButton = new import_obsidian15.Setting(footerEl);
    saveButton.addButton(
      (button) => {
        return button.setTooltip("Save").setIcon("checkmark").onClick(() => __async(this, null, function* () {
  ...
  updateContentBasedOnSelection(value, nextTabs) {
    ...
    if (value === "general") {
      ...
      new import_obsidian15.Setting(nextTabs).setName(i18nConfig.NotionCustomTitle).setDesc(i18nConfig.NotionCustomTitleDesc).addToggle(
      ...
      this.createSettingEl(nextTabs, i18nConfig.NotionAPI, i18nConfig.NotionAPIDesc, "password", i18nConfig.NotionAPIText, this.data.notionAPI, "data", "notionAPI");
      this.createSettingEl(nextTabs, i18nConfig.DatabaseID, i18nConfig.DatabaseIDDesc, "password", i18nConfig.DatabaseIDText, this.data.databaseID, "data", "databaseID");
      new import_obsidian15.Setting(nextTabs).setName(i18nConfig.NotionCustomValues).setDesc(i18nConfig.NotionCustomValuesDesc).addButton(
        (button) => {
          return button.setTooltip("Add new property").setIcon("plus").onClick(() => __async(this, null, function* () {
  ...
  renderCustomPreview(properties, nextTabs) {
  ...
  createSettingEl(contentEl, name, desc, type, placeholder, holderValue, dataRecord, settingsKey) {
    if (type === "password") {
      return new import_obsidian15.Setting(contentEl).setName(name).setDesc(desc).addText((text) => {
      ...
      return new import_obsidian15.Setting(contentEl).setName(name).setDesc(desc).addToggle(
        (toggle) => toggle.setValue(holderValue).onChange((value) => __async(this, null, function* () {
          this[dataRecord][settingsKey] = value;
        }))
      );
    } else if (type === "text") {
      return new import_obsidian15.Setting(contentEl).setName(name).setDesc(desc).addText(
...
var PreviewModal = class extends import_obsidian16.Modal {
  constructor(app, plugin, settingTab, dbDetails) {
    super(app);
    this.plugin = plugin;
    this.settingTab = settingTab;
  ...
  display() {
    ...
    const apiKeySetting = new import_obsidian16.Setting(previewEl);
    ...
    apiKeySetting.addExtraButton((button) => {
      return button.setTooltip("Copy API Key").setIcon("clipboard").onClick(() => {
        ...
        new import_obsidian16.Notice("API Key copied to clipboard");
      });
    });
    apiKeySetting.settingEl.style.display = "none";
    new import_obsidian16.Setting(previewEl).setName("Database ID").addExtraButton((button) => {
    ...
    const dbIdSetting = new import_obsidian16.Setting(previewEl);
    ...
    dbIdSetting.addExtraButton((button) => {
      return button.setTooltip("Copy Database ID").setIcon("clipboard").onClick(() => {
        ...
        new import_obsidian16.Notice("Database ID copied to clipboard");
      });
    });
    dbIdSetting.settingEl.style.display = "none";
    if (this.dbDetails.format === "custom") {
      const customPropertiesEl = new import_obsidian16.Setting(previewEl);
      customPropertiesEl.setName("Custom Properties").addTextArea((text) => text.setValue(JSON.stringify(this.dbDetails.customProperties, null, 2)).setDisabled(true));
    }
  }
  onOpen() {
    this.display();
...
var EditModal = class extends SettingModal {
  ...
  display() {
    ...
    const nextTabs = contentEl.createDiv("next-tabs");
    new import_obsidian17.Setting(editDiv).setName(i18nConfig.databaseFormat).setDesc(i18nConfig.databaseFormatDesc).addDropdown((component) => {
    ...
    let footerEl = contentEl.createDiv("save-button");
    let saveButton = new import_obsidian17.Setting(footerEl);
    saveButton.addButton(
      (button) => {
        return button.setTooltip("Save").setIcon("checkmark").onClick(() => __async(this, null, function* () {
  ...
  updateContentBasedOnSelection(value, nextTabs) {
    ...
    if (value === "general") {
      ...
      new import_obsidian17.Setting(nextTabs).setName(i18nConfig.NotionCustomTitle).setDesc(i18nConfig.NotionCustomTitleDesc).addToggle(
      ...
      this.createSettingEl(nextTabs, i18nConfig.NotionAPI, i18nConfig.NotionAPIDesc, "password", i18nConfig.NotionAPIText, this.dataTemp.notionAPITemp, "dataTemp", "notionAPITemp");
      this.createSettingEl(nextTabs, i18nConfig.DatabaseID, i18nConfig.DatabaseIDDesc, "password", i18nConfig.DatabaseIDText, this.dataTemp.databaseIDTemp, "dataTemp", "databaseIDTemp");
      new import_obsidian17.Setting(nextTabs).setName(i18nConfig.NotionCustomValues).setDesc(i18nConfig.NotionCustomValuesDesc).addButton(
        (button) => {
          return button.setTooltip("Add new property").setIcon("plus").onClick(() => __async(this, null, function* () {
            let customModal = new CustomModal(this.app);
            customModal.onClose = () => {
...
var DeleteModal = class extends import_obsidian18.Modal {
  constructor(app, plugin, settingTab, dbDetails) {
    super(app);
    this.data = {
      deleted: false
  ...
  display() {
    ...
    let footerEl = contentEl.createDiv("save-button");
    let deleteButton = new import_obsidian18.Setting(footerEl);
...
var ObsidianSettingTab = class extends import_obsidian19.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian19.Setting(containerEl).setName("Add New Database").setDesc("Add New Database").addButton((button) => {
  ...
  // create a function to create a div with a style for pop over elements
  createStyleDiv(className, commandValue = false) {
  ...
  createSettingEl(containerEl, name, desc, type, placeholder, holderValue, settingsKey) {
    if (type === "password") {
      return new import_obsidian19.Setting(containerEl).setName(name).setDesc(desc).addText((text) => {
        text.inputEl.type = type;
        return text.setPlaceholder(placeholder).setValue(holderValue).onChange((value) => __async(this, null, function* () {
      ...
      return new import_obsidian19.Setting(containerEl).setName(name).setDesc(desc).addToggle(
        (toggle) => toggle.setValue(holderValue).onChange((value) => __async(this, null, function* () {
          this.plugin.settings[settingsKey] = value;
          yield this.plugin.saveSettings();
      ...
      return new import_obsidian19.Setting(containerEl).setName(name).setDesc(desc).addText(
        (text) => text.setPlaceholder(placeholder).setValue(holderValue).onChange((value) => __async(this, null, function* () {
          this.plugin.settings[settingsKey] = value;
          yield this.plugin.saveSettings();
          yield this.plugin.commands.updateCommand();
  ...
  showDatabase() {
    ...
    for (let key in this.plugin.settings.databaseDetails) {
      ...
      let settingEl = new import_obsidian19.Setting(databaseDiv).setName(`${dbDetails.fullName} (${dbDetails.abName})`).setDesc(dbDetails.format);
...
// src/main.ts
var ObsidianSyncNotionPlugin = class extends import_obsidian20.Plugin {
  onload() {
    return __async(this, null, function* () {
